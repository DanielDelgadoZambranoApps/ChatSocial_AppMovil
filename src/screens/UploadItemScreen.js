...
import { UploadItem } from '../functions/firebase-firestore-funtions'
...
const UploadItemScreen =({navigation})=>{
      ...
      Alert.alert("Error", "Complete todos los campos",
        ...
        if (!hola) {
          ...
          if (Number(amount) < 1 ){
            ...
            if(CheckConnectivity()){
              UploadItem(itemName, itemDescription, images,3, amount, userName, userMail, userID)
              setItemDescription("")
              setImages(null)
              setItemName("")
              setCredits("")
  ...
  return(
    <>
      ...
      <View style={{backgroundColor:'#F5FFEE'}} >

                      ...
                      <React.Fragment key={route.key} >
                        {newGroup ? (
                          ...
                          <>
                            { photoLink ? 
                            <>
                              <Image source={{ uri:photoLink }} style={{ height: 150, width: 150,borderRadius: 75, marginTop:30, marginBottom:30}} />
                            </>
                            :
                            <>
                              <Image source={require("./assets/ProfilePic.png")} style={{ height: 150, width: 150,borderRadius: 75, marginTop:30, marginBottom:30}} />
                            </>
                            }
                          </>
                          :
                          ...
                          <Image source={require("./assets/ProfilePic.png")}
                            style={{ height: 150, width: 150,borderRadius: 75, marginTop:30, marginBottom:30}} />
                          </>
                          }
                        </View> ) : null}
                        <DrawerItem
